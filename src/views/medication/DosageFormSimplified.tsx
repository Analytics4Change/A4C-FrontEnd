...
import { DosageFormInputs } from './DosageFormInputs';
import { TotalAmountInputs } from './TotalAmountInputs';
import { FrequencyConditionInputs } from './FrequencyConditionInputs';
...
export const DosageForm = observer((props: DosageFormProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Frequency and Condition Inputs */}
